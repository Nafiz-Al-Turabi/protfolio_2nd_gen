        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 text-white">
            <div className="flex items-center gap-4 mb-2">
              ...
              <h1 className="text-4xl md:text-2xl xl:text-5xl font-bold">
                <span className="text-yellow-500 uppercase tracking-tight">
                  I'M Nafiz al Turabi
                </span>
              </h1>
            </div>
            <h2 className="text-3xl md:text-2xl xl:text-5xl font-bold mb-6 text-white tracking-tight">
              WEB DESIGNER
            </h2>
            <p className="text-gray-300 text-sm  md:text-xs xl:text-lg  mb-8 max-w-xl">
